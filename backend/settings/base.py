"""
Base Django settings for fastresult_backend project.
This is shared configuration for all environments.
"""
...
# AUTH_USER_MODEL = 'accounts.User'  # Commented out - using built-in User
